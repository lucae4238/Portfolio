...
position: absolute;
top: 50%;
left: ${props => props.position === 'left' ? '5%' : '92.5%'};
right: ${props => props.position === 'right' ? '5%' : '92.5%'};
background: yellow;
height: 12rem;
width: 3rem;
`;
